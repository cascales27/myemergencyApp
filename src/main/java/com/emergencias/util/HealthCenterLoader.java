...
public class HealthCenterLoader {
    ...
    public static List<HealthCenter> loadFromFile() {
        ...
        try {
            InputStream is = HealthCenterLoader.class.getResourceAsStream("/health_centers.json");
            ...
            Map<String, Object> jsonMap =
                    gson.fromJson(new InputStreamReader(is), Map.class);

            List<Map<String, Object>> features =
                    (List<Map<String, Object>>) jsonMap.get("features");
